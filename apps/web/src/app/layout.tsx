...
export const metadata: Metadata = {
  ...
  description: 'Sistema de inteligência artificial avançado inspirado em interfaces futuristas.',
  keywords: ['AI', 'JARBAS', 'Assistant', 'Artificial Intelligence', 'Neural System', 'Cyber Interface'],
  authors: [{ name: 'Junior' }],
  themeColor: '#00F0FF',
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR" suppressHydrationWarning className="dark scroll-smooth">
      <body className="relative min-h-screen overflow-hidden bg-[#030712] text-white font-sans antialiased selection:bg-cyan-400/30 selection:text-white">
        ...
        {/* CONTEÚDO — padding bottom para não ficar atrás do nav */}
        <main className="relative z-10 flex min-h-screen flex-col pb-16">
          {children}
        </main>
